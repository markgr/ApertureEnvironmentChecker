...
/******************************************************
 *
 * Method: calculateStringSize
 * Returns: CGSize - the sizde of the string for the PDF doc
 * Description: This function calculates the size needed to put all of the details for the string on the page
 *
 *****************************************************/
-(CGSize)calculateStringSize:(NSString*)string withFont:(UIFont*)font andMaxWidth:(CGFloat)width
{
    // Create a dictionary for the boundingRect
    ...
    CGRect rect = [string boundingRectWithSize:CGSizeMake(width, 300) options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil];
    return rect.size;
}
...
- (void)setStatus:(NSString *)string {
    ...
    if(string)
    {
        ...
        CGSize stringSize = [self calculateStringSize:string withFont:self.stringLabel.font andMaxWidth:200];
